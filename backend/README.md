...
## Project Structure
    ...
    ├── testprojectdetails_2  # Django project configurations
...
1. Clone this repo and `cd testprojectdetails_2`
...
2. Clone this repo and `cd testprojectdetails_2`
